  ...
  return (
    <section id="about" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="mb-16 md:text-center max-w-3xl mx-auto">
        <h2 className="text-3xl md:text-5xl font-bold text-brand-dark mb-6">More Than Just Distributors. <br/> We Are On-Site Partners.</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(200px,auto)]">
        ...
        <div className="md:col-span-2 rounded-3xl p-8 bg-brand-dark text-white relative overflow-hidden group">
        ...
        <div className="row-span-2 rounded-3xl p-8 bg-white border border-gray-100 shadow-sm relative overflow-hidden group hover:border-brand/50 transition-colors">
          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-gray-50 opacity-0 group-hover:opacity-100 transition-opacity"></div>
          <div className="relative z-10 h-full flex flex-col">
            <div className="w-12 h-12 rounded-xl bg-gray-50 flex items-center justify-center mb-6">
               <Factory className="text-brand-dark" size={24} />
            </div>
            <h3 className="text-2xl font-bold text-brand-dark mb-4">Hands-On Plant Visits</h3>
        ...
        <div className="rounded-3xl p-8 bg-[#F0FDF4] border border-green-100 relative overflow-hidden">
          <div className="relative z-10">
            <div className="w-12 h-12 rounded-xl bg-brand/20 flex items-center justify-center mb-4">
              <TrendingUp className="text-green-700" size={24} />
            </div>
            <h3 className="text-xl font-bold text-brand-dark mb-2">Fair, Direct Pricing</h3>
        ...
        {/* Medium Card - Clients */}
        <div className="rounded-3xl p-8 bg-white border border-gray-100 shadow-sm relative overflow-hidden hover:shadow-md transition-shadow">
          <div className="relative z-10">
            <div className="w-12 h-12 rounded-xl bg-gray-50 flex items-center justify-center mb-4">
              <Handshake className="text-brand-dark" size={24} />
            </div>
            <h3 className="text-xl font-bold text-brand-dark mb-2">Trusted by Giants</h3>
            <p className="text-sm text-gray-600">
        ...
        <div className="md:col-span-3 rounded-3xl p-8 bg-gradient-to-r from-gray-900 to-gray-800 text-white relative overflow-hidden">
           ...
           <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
             ...
             <a href="#contact" className="whitespace-nowrap px-6 py-3 bg-brand text-brand-dark font-semibold rounded-full hover:bg-white transition-colors">
